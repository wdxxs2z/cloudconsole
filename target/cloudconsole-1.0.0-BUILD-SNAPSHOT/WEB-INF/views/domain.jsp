...
<script type="text/javascript">
	function doDeleteDomain(type,domainName){
		$.ajax({
			type:"GET",
			url:"domainOperation",
			cache:"false",
			...
			<div class="span1">
				...
				<aside class="side-left">
					<ul class="sidebar">
						...
						<li class="active first"><a href="./domain" title="Routes">
								<div class="helper-font-24">
									<i class="icofont-table"></i>
								</div> <span class="sidebar-text">域名管理</span>
						</a>
						<ul class="sub-sidebar corner-top shadow-silver-dark">
								<li><a href="./addDomain" title="cluster monit">
										<div class="helper-font-24">
			...
			<div class="span11">
				...
				<div class="content">
					<div class="content-header">
						...
						<h2>
							<i class="icofont-home"></i> 域名管理  <small>域名-Domain-org</small>
						</h2>
					</div>
					<!-- /content-header -->
									...
									<div class="box-body">
										<table class="table table-bordered table-striped autoTable">
											...
											%>
												<tr>
													<td>
													<a data-toggle="modal" data-target="#routeModal" href="domainInfo?name=<%=domain.getName() %>"><%=domain.getName()%></a>
													<!-- Modal -->
                                                        	...
                                                        	<div class="modal-content">
            													<div class="modal-header">
                													<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                 													<h4 class="modal-title">域名使用路由情况</h4>

            													</div>
            												<div class="modal-body"><div class="domaintable"></div></div>
													...
													<td><%=domain.getOwner().getName() %></td>
													<td><%=domain.getMeta().getCreated().toString() %></td>
													<td style="vertical-align:middle; text-align:center;">
													<a href="#" onclick="if(confirm('您确定要删除此域名[<%=domain.getName()%>]?')){doDeleteDomain('delete','<%=domain.getName()%>')}"><button class="btn btn-inverse"><i class="icon-remove"></i></button></a>
													</td>
												</tr>
											<%
												}
