...
<meta charset="utf-8" />
	...
	content="width=device-width, initial-scale=1.0" />
        ...
        <!-- google font -->
        <link href="<c:url value="/css/google-css.css"/>"
                    ...
                    <aside class="side-left">
                        <ul class="sidebar">
                            ...
                            <li  class="active first">
                                ...
                                <ul class="sub-sidebar corner-top shadow-silver-dark">
									<li><a href="./addDomain" title="add domains">
										<div class="helper-font-24">
											<i class="icofont-hand-up"></i>
										</div> <span class="sidebar-text">添加域名</span>
									</a>
									</li>
								</ul>
                            </li>
                            ...
                            <ul class="content-header-action pull-right">
                                <li>
                                    <a href="#">
                                        ...
                                        <div class="action-text color-green">8765 <span class="helper-font-small color-silver-dark">访问数量</span></div>
                                    </a>
                                </li>
                                <li class="divider"></li>
                                <li>
                                ...
                                <li>
                                    <a href="#">
                                        ...
                                        <div class="action-text color-red">4367 <span class="helper-font-small color-silver-dark">应用数量</span></div>
                                    </a>
                                </li>
                            </ul>
                            <h2><i class="icofont-home"></i> 域名管理  <small>Domain--增加域名</small></h2>
                        </div><!-- /content-header -->
                        				...
                        				<div class="box-header grd-white corner-top">
											<div class="header-control">
												<a data-box="collapse"><i class="icofont-caret-up"></i></a> <a
													data-box="close" data-hide="bounceOutRight">&times;</a>
											</div>
											<span>增加域名列表</span>
										</div>
										<div class="box-body">
											<form class="form-horizontal" action="./newDomain" method="post" >
												<!-- 域名框 -->
												<div class="control-group">
													<label class="control-label" for="inputAuto">请填写域名：</label>
													<div class="controls">
														<input type="text" id="domainname" name="domainname" class="grd-white" required="required" /> 
													</div>
												</div>
												<!-- 设置组织 -->
												<div class="control-group">
													<label class="control-label" for="inputSelect">请选择所属：</label>
													<div class="controls">
													<select id="orgName" name="orgName" data-form="inputSelect" style="width:220px" data-placeholder="选择您所要附加的组织">
														<option></option>
														<%
															List<CloudOrganization> orgs = client.getOrganizations();
															for(CloudOrganization cloudOrg : orgs){
														%>
														<option><%=cloudOrg.getName()%></option>
														<%
															}
														%>
													</select>
												...
												<!-- 添加动作 -->
												<div class="control-group">
                                            	<label class="control-label" for="submit">添加域名：</label>
													<div class="controls">
														<input type="submit" name="submit" class="btn btn-success" value="添加域名" />
													</div>					
												</div>
											</form>
										</div>
