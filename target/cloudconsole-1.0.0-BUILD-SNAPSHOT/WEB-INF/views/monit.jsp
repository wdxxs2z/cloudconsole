...
<%@page import="com.cloudconsole.model.CloudComponent"%>
...
<%
	...
	List<CloudComponent> components = (List<CloudComponent>) session.getAttribute("components");
%>
<!DOCTYPE html>
<html>
<head>
			...
			<div class="span1">
				...
				<aside class="side-left">
					<ul class="sidebar">
						...
						<li class="active first"><a href="#" title="more">
			...
			<div class="span11">
				...
				<div class="content">
					<div class="content-header">
						...
						<h2>
							<i class="icofont-home"></i> Monit监控主机 <small>Monit Server</small>
						</h2>
					</div>
					<!-- /content-header -->
					...
					<div class="content-breadcrumb">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Monit监控服务器列表</li>
						</ul>
						<!--/breadcrumb-->
					</div>
					<!-- /content-breadcrumb -->
							...
							<div class="span12">
								<div class="box corner-all">
									<div class="tab-content">
                                		...
                                		<tbody>
                                		<%
                                			for (CloudComponent component : components) {
                                		%>
                                			<tr>
                                				<td><%=component.getComponent() %></td>
                                				<td><%=component.getIndex() %></td>
                                				<td><%=component.getHost() %></td>
                                				<td></td>
                                				<td></td>
                                				<td></td>
                                			</tr>
