...
<link rel="stylesheet"
	href="<c:url value="/bonus-page/resume/css/resume.css"/>" />
<link rel="stylesheet"
	href="<c:url value="/bonus-page/resume/css/resume-control.css"/>" />
<link rel="stylesheet"
			...
			<div class="span11">
				...
				<div class="content">
					<div class="content-header">
						...
						<h2>
							<i class="icofont-home"></i> 用户信息 <small>userinfo</small>
						</h2>
					</div>
					<!-- /content-header -->
					...
					<div class="content-breadcrumb">
						...
						<ul class="breadcrumb">
							...
							<li class="active">CloudFoundry用户信息</li>
						</ul>
						<!--/breadcrumb-->
					</div>
					<!-- /content-breadcrumb -->
							...
							<div class="span12">
								<div class="box-tab corner-all">
									<div class="box-header corner-top">
										<ul class="nav nav-tabs bg-blue color-white">
											<li class="active"><a data-toggle="tab" href="#boxtab-1"><strong>用户信息总概览</strong></a></li>
											<li><a data-toggle="tab" href="#boxtab-2"><strong>用户账户变更</strong></a></li>
											<li><a data-toggle="tab" href="#boxtab-3"><strong>拥有项目进度</strong></a></li>
										</ul>
									</div>
									<div class="box-body">
										<div class="tab-content">
														...
														<div class="span6">
															<div class="right">
																<div class="title display-table">
																	<p>成员名</p>
																	<span class="pull-right"><%=client.getCloudInfo().getUser() %></span>
																</div>
																<div class="title display-table">
																	<p>云端描述</p>
																	<span class="pull-right"><%=client.getCloudInfo().getDescription() %></span>
																</div>
																<div class="title display-table">
																	<p>Cloud Support</p>
																	<span class="pull-right"><%=client.getCloudInfo().getSupport()%></span>
																</div>
																<div class="title display-table">
																	<p>Cloud Version</p>
																	<span class="pull-right">Cloud Version : <%=client.getCloudInfo().getVersion() %>.0</span>
																</div>
																<div class="title display-table">
																	<p>Max Apps</p>
																	<span class="pull-right"><%=client.getCloudInfo().getLimits().getMaxApps() %> APPS</span>
																</div>
																<div class="title display-table">
																	<p>Max Memory</p>
																	<span class="pull-right"><%=client.getCloudInfo().getLimits().getMaxTotalMemory() %> M</span>
																</div>
															</div>
														</div>
														<!--/right-->
											...
											<div class="tab-pane fade" id="boxtab-2">
												<form class="form-horizontal" method="post" id="form-validate" action="changeCloudUserPSW">
													<fieldset>
														<legend>修改用户密码</legend>
														<div class="control-group">
															<label class="control-label" for="cloudUserName" >云端用户名：</label>
                                   							<div class="controls">
                                                                <input type="text" readonly="readonly" id="cloudUserName" name="cloudUserName" class="grd-white" value=<%=client.getCloudInfo().getUser() %> />
                                                            </div>
														</div>
														<div class="control-group">
                                							<label class="control-label" for="oldCloudUserPSW">原用户密码：</label>
					                                		<div class="controls">
					                                			<input type="password" name="oldCloudUserPSW" class="grd-white" id="oldCloudUserPSW" data-validate="{required: true, messages:{required:'请填写原来的用户密码'}}" />
					                                		</div>
					                               		</div>
														<div class="control-group">
                                							<label class="control-label" for="changePassword">请修改后的用户密码：</label>
					                                		<div class="controls">
					                                			<input type="password" name="changePassword" class="grd-white" id="changePassword" data-validate="{required: true,minlength: 6, messages:{required:'请填写至少6位数的密码'}}" />
					                                		</div>
					                               		</div>
					                               		<div class="control-group">
					                                	<label class="control-label" for="cpassword">确认修改后的密码：</label>
					                                		<div class="controls">
					                                			<input type="password" name="cpassword" class="grd-white" id="cpassword" 
					                                			data-validate="{required: true, equalTo: '#changePassword', messages:{required:'重复上面的密码，注意认真填写', equalTo: '两次密码不一致，请认真填写'}}" />
					                                		</div>
					                               		</div>
											...
											<div class="tab-pane fade in active" id="boxtab-3"></div>
										</div>
									</div>
								</div>
							</div>
