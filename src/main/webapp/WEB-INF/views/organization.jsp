                        ...
                        <ul class="sidebar">
                            ...
                            <li>
                                ...
                                <ul class="sub-sidebar-form corner-top shadow-white">
                                    ...
                                    <li>
                                        <input type="file" data-form="uniform" onchange="警告('你的应用正在上传...')" />
                                    </li>
                                    <li class="divider"></li>
                                    <li>
                            ...
                            <li>
                                <a href="./services" title="ServiceInstaces">
                                    <div class="helper-font-24">
                                        <i class="icofont-columns"></i>
                                    </div>
                                    <span class="sidebar-text">服务实例</span>
                                </a>
                            </li>
                            <li>
         		...
         		<div class="span11">
                    ...
                    <div class="content">
                    	<div class="content-header">
                            ...
                            <h2><i class="icofont-home"></i> 租户管理  <small>用户-Organization</small></h2>
                        </div><!-- /content-header -->
